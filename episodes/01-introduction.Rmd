...
# Appendix: Model solutions to DIY exercises
...
## DIY3: Find NaN in dataframe
 ...
 Check the entry 'Self-employed' for ID LP001059. It shows how a missing value is represented as 'NaN' (not a number).
...
## DIY4: Practice
 ...
 Use your own .csv data set to practice. Read it into a dataframe, check its header, access indivdual values or sets of values. Create a statistics using `describe` and check for missing values using `.isnull`.
...
## DIY5: Using a template
 ...
 Write code to calculate the number of samples labelled male.
...
Plot the boxplots of the 'ApplicantIncome' and the 'CoapplicantIncome' using the above code. 
...
## DIY7: Create histogram from data column
